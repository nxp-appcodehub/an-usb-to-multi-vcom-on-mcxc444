...
#define USB_DESCRIPTOR_LENGTH_CDC_CIC_INTERRUPT_ENDPOINT (0x07U)
#else

#define USB_DESCRIPTOR_LENGTH_CDC_CIC_INTERRUPT_ENDPOINT (0x00U)
...
#define USB_CDC_VCOM_CIC_ENDPOINT_COUNT_SUM (0*USB_DEVICE_CONFIG_CDC_ACM)
#define USB_CDC_VCOM_DIC_ENDPOINT_COUNT_SUM (2*USB_DEVICE_CONFIG_CDC_ACM)

#define USB_CDC_DESCRIPTOR_INSTANCE_LENGTH  (USB_IAD_DESC_SIZE + \
											...
											USB_DESCRIPTOR_LENGTH_CDC_CIC_INTERRUPT_ENDPOINT + \
											USB_DESCRIPTOR_LENGTH_INTERFACE + \
...
#else
/* No  interrupt IN endpoint for CIC interface */
